...
import com.grillecube.client.renderer.model.dae.datastructures.Vertex;
import com.grillecube.client.renderer.model.dae.datastructures.VertexSkinData;
...
public class GeometryLoader {
	...
	public MeshData extractModelData() {
		...
		return new MeshData(positionArray, texturesArray, normalsArray, indicesArray, jointIdsArray, weightsArray);
	}
	...
	private void initArrays() {
		this.positionArray = new float[vertices.size() * 3];
