...
/*V*/				{new T(Face.FRONT, 0, 8, 3, 2, 0, 3)},
/*V*/				{new T(Face.BACK, 0, 1, 9, 3, 0, 1)},
/*V*/				{new T(Face.TOP, 1, 8, 3, 3, 1, 0), new T(Face.TOP, 9, 8, 1, 2, 1, 3)},
/*V*/				{new T(Face.TOP, 1, 2, 10, 0.5f, 0.5f, 0.0f, 1.0f, 1.0f, 1.0f)},
					{new T(Face.FRONT, 0, 8, 3, 3, 0, 2), new T(Face.TOP, 1, 2, 10, 2, 3, 0)},
/*V*/				{new T(Face.LEFT, 9, 2, 10, 2, 0, 3), new T(Face.LEFT, 0, 2, 9, 1, 0, 2)},
/*V*/				{new T(Face.FRONT, 2, 8, 3, 2, 3, 0), new T(Face.LEFT, 2, 10, 8, 1, 2, 0), new T(Face.LEFT, 10, 9, 8, 2, 3, 0)},
...
/*V*/				{new T(Face.TOP, 1, 11, 2, 1, 0, 2), new T(Face.TOP, 1, 9, 11, 3, 2, 0), new T(Face.TOP, 9, 8, 11, 2, 1, 0)},
...
/*V*/				{new T(Face.LEFT, 9, 8, 10, 2, 1, 3), new T(Face.LEFT, 10, 8, 11, 3, 1, 0)},
					...
					{new T(Face.BOT, 4, 7, 8, 0, 0, 0)},
					{new T(Face.TOP, 4, 3, 0, 0, 0, 0), new T(Face.TOP, 7, 3, 4, 0, 0, 0)},
					{new T(Face.TOP, 0, 1, 9, 0, 0, 0), new T(Face.TOP, 8, 4, 7, 0, 0, 0)},
					{new T(Face.TOP, 4, 1, 9, 0, 0, 0), new T(Face.TOP, 4, 7, 1, 0, 0, 0), new T(Face.TOP, 7, 3, 1, 0, 0, 0)},
					{new T(Face.TOP, 1, 2, 10, 0, 0, 0), new T(Face.TOP, 8, 4, 7, 0, 0, 0)},
					{new T(Face.TOP, 3, 4, 7, 0, 0, 0), new T(Face.TOP, 3, 0, 4, 0, 0, 0), new T(Face.TOP, 1, 2, 10, 0, 0, 0)},
					{new T(Face.TOP, 9, 2, 10, 0, 0, 0), new T(Face.TOP, 9, 0, 2, 0, 0, 0), new T(Face.TOP, 8, 4, 7, 0, 0, 0)},
					{new T(Face.TOP, 2, 10, 9, 0, 0, 0), new T(Face.TOP, 2, 9, 7, 0, 0, 0), new T(Face.TOP, 2, 7, 3, 0, 0, 0), new T(Face.TOP, 7, 9, 4, 0, 0, 0)},
					{new T(Face.TOP, 8, 4, 7, 0, 0, 0), new T(Face.TOP, 3, 11, 2, 0, 0, 0)},
					{new T(Face.TOP, 11, 4, 7, 0, 0, 0), new T(Face.TOP, 11, 2, 4, 0, 0, 0), new T(Face.TOP, 2, 0, 4, 0, 0, 0)},
					{new T(Face.TOP, 9, 0, 1, 0, 0, 0), new T(Face.TOP, 8, 4, 7, 0, 0, 0), new T(Face.TOP, 2, 3, 11, 0, 0, 0)},
					{new T(Face.TOP, 4, 7, 11, 0, 0, 0), new T(Face.TOP, 9, 4, 11, 0, 0, 0), new T(Face.TOP, 9, 11, 2, 0, 0, 0), new T(Face.TOP, 9, 2, 1, 0, 0, 0)},
					{new T(Face.TOP, 3, 10, 1, 0, 0, 0), new T(Face.TOP, 3, 11, 10, 0, 0, 0), new T(Face.TOP, 7, 8, 4, 0, 0, 0)},
					{new T(Face.TOP, 1, 11, 10, 0, 0, 0), new T(Face.TOP, 1, 4, 11, 0, 0, 0), new T(Face.TOP, 1, 0, 4, 0, 0, 0), new T(Face.TOP, 7, 11, 4, 0, 0, 0)},
					{new T(Face.TOP, 4, 7, 8, 0, 0, 0), new T(Face.TOP, 9, 0, 11, 0, 0, 0), new T(Face.TOP, 9, 11, 10, 0, 0, 0), new T(Face.TOP, 11, 0, 3, 0, 0, 0)},
