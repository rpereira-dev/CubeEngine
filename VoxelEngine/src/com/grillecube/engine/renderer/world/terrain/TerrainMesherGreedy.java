...
public class TerrainMesherGreedy extends TerrainMesher {
	...
	private void createBlockFaces(Terrain terrain, BlockFace[][][][] faces, Block block, int x, int y, int z) {
		...
		faces[Face.BACK][x][y][z] = super.getBlockFace(terrain, block, x, y, z, Face.F_BACK);
		faces[Face.FRONT][x][y][z] = super.getBlockFace(terrain, block, x, y, z, Face.F_FRONT);
		faces[Face.BOT][x][y][z] = super.getBlockFace(terrain, block, x, y, z, Face.F_BOT);
		faces[Face.TOP][x][y][z] = super.getBlockFace(terrain, block, x, y, z, Face.F_TOP);
		faces[Face.LEFT][x][y][z] = super.getBlockFace(terrain, block, x, y, z, Face.F_LEFT);
		faces[Face.RIGHT][x][y][z] = super.getBlockFace(terrain, block, x, y, z, Face.F_RIGHT);
	}
}
