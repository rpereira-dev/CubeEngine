...
public class TerrainRendererFactory {
	...
	private ArrayList<TerrainMesh> _rendering_list_shadow;
	...
	public void initialize() {
		...
		this._rendering_list_shadow = new ArrayList<TerrainMesh>();
	}
	...
	public void deinitialize() {
		...
		this._rendering_list_shadow = null;
	}
	...
	public void update(TerrainRenderer renderer) {
		...
		ShadowCamera shadow_camera = renderer.getParent().getWorldRenderer().getShadowCamera();

		this.updateLoadedTerrains(world);
		this.updateRenderingList(camera, shadow_camera);
	...
	private void updateRenderingList(CameraProjectiveWorld camera, ShadowCamera shadow_camera) {
	...
	private void getRenderingListFrustumCull(CameraProjectiveWorld camera, ShadowCamera shadow_camera) {
		...
		for (TerrainMesh mesh : this._meshes.values()) {
			...
			this._rendering_list_shadow.add(mesh);
	...
	public ArrayList<TerrainMesh> getShadowRenderingList() {
		return (this._rendering_list_shadow);
	}
