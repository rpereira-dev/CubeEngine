...
public class TerrainRendererThread extends Thread
{
	...
	public void	run()
	{
		...
		{
			World world = this._game.getCurrentWorld();
			Camera camera = this._game.getRenderer().getCamera();
...
//		Logger.get().log(Logger.Level.DEBUG, "Terrain rendered: " + terrains.size());
	...
	{
		//if the terrain has been initialized and is empty
